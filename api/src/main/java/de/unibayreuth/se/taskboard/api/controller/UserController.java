...
public class UserController {
        ...
        public ResponseEntity<Optional<UserDto>> getById(@PathVariable UUID id) {
                try {
                        ...
                        return ResponseEntity.ok(Optional.ofNullable(userDtoMapper.fromOptional(user)));
        ...
        @Operation(
                ...
                responses = {
                        ...
                        @ApiResponse(
                                responseCode = "400",
                                description = "The user already exists or request is invalid."
                        )
                }
        )
        @PostMapping
        public ResponseEntity<UserDto> create(@RequestBody @Valid UserDto userDto) {
                try {
                        User createdUser = userService.create(userDtoMapper.toBusiness(userDto));
                        return ResponseEntity.ok(userDtoMapper.fromBusiness(createdUser));
